...
{
    public partial class FormSearchMalfunction : Form
    {
        private BindingList<MalfunctionRow> bindinglist;

        public List<Malfunction> Malfunctions { get; set; }

        public IMalfunctionReceiver Receiver;

        private static FormSearchMalfunction instance;

        public static FormSearchMalfunction Instance
        {
            get
            {
                if (instance == null)
                    instance = new FormSearchMalfunction();

                return instance;
            }
        }

        private FormSearchMalfunction()
        {
            InitializeComponent();
            ...
            this.FormClosing += FormSearchMalfunction_FormClosing;
            this.Activated += FormSearchMalfunction_Activated;
        ...
        private void FormSearchMalfunction_Activated(object sender, EventArgs e)
        {
            SetDataGridView();
        }
        ...
        private void FormSearchMalfunction_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void SetDataGridView()
        {
            ...
            foreach (var row in Malfunctions)
                bindinglist.Add(row);
